...
public class generalMakeIdChild extends AppCompatActivity {
    ...
    EditText edtNameM, edtPassword, edtCheckPass, edtNum1, edtNum2, edtEmail, edtPEmail;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnComplete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String getParent_call = edtPEmail.getText().toString();
                //부모 전화
                //이미지 루트 데려오기
                if (chkNull(getGeneral_email, getGeneral_password, getGeneral_name, getGeneral_call)) {
                    ...
                    mAuth.createUserWithEmailAndPassword(getGeneral_email, getGeneral_password)
                            .addOnCompleteListener(generalMakeIdChild.this, new OnCompleteListener<AuthResult>() {
                                @Override
    ...
    //로그인 값을 저장
    public void makeId(String getGeneral_email, String getGeneral_password, String getGeneral_name, String getGeneral_sex, String getGeneral_birth,String getParent_call, String getGeneral_call, String getGeneral_route) {
        result = new HashMap<>();
        result.put("parent_call", getParent_call);
