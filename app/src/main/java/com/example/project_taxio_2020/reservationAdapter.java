...
public class reservationAdapter extends BaseAdapter {
    ...
    public reservationAdapter(Context context, ArrayList<reservationItem> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        recruit_Textview.setText(list.get(position).getRecruit());
        recruitplace_Textview.setText(list.get(position).getRecruitplace());
